...
Unmanic injects these helpers as keyword arguments. Only declare the helpers your runner actually uses, and type them as helper classes rather than instances.
...
New plugins should use keyword arguments so Unmanic can pass helpers by name. Only declare the helpers your runner actually uses:
