...
If a runner needs Unmanic's shared helper classes, declare only the helpers it actually uses and let Unmanic inject them by keyword. See [Sharing Data Between Plugins](/docs/development/writing_plugins/sharing_data_between_plugins).
