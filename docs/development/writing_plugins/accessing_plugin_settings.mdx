...
![Unmanic Plugins - Settings](/img/unmanic-plugin-settings-basic.png "unmanic-plugin-settings-basic")
...
![Unmanic Plugins - Settings Advanced Dynamic Hidden](/img/unmanic-plugin-settings-advanced-dynamic-hidden1.png "unmanic-plugin-settings-advanced-dynamic-hidden1")
![Unmanic Plugins - Settings Advanced Dynamic Shown](/img/unmanic-plugin-settings-advanced-dynamic-hidden2.png "unmanic-plugin-settings-advanced-dynamic-hidden2")
...
![Unmanic Plugins - Settings Advanced Labels](/img/unmanic-plugin-settings-advanced-labels.png "unmanic-plugin-settings-advanced-labels")
...
![Unmanic Plugins - Settings Advanced Select](/img/unmanic-plugin-settings-advanced-select.png "unmanic-plugin-settings-advanced-select")
...
![Unmanic Plugins - Settings Advanced Textarea](/img/unmanic-plugin-settings-advanced-textarea.png "unmanic-plugin-settings-advanced-textarea")
...
![Unmanic Plugins - Settings Advanced Browse Directory](/img/unmanic-plugin-settings-advanced-browse-directory.png "unmanic-plugin-settings-advanced-browse-directory")
...
![Unmanic Plugins - Settings Advanced Slider](/img/unmanic-plugin-settings-advanced-slider.png "unmanic-plugin-settings-advanced-slider")
