...
[**Plugin Manager CLI**](/docs/development/plugin_manager_cli).
...
Be sure to test your Plugin with the [**Plugin Manager CLI**](/docs/development/plugin_manager_cli) as required.
