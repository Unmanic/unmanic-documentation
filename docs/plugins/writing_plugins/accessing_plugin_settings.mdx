...
class Settings(PluginSettings):
    ...
    In the blow settings:
        ...
        Advanced - Select dropdown          - will become 'select' input in WebUI
        Advanced - Text area input          - will become 'textarea' input in WebUI
    ...
    """
    form_settings = {
        "Advanced - Select dropdown with custom label (will become 'select' input in WebUI)": {
            "input_type":     "select",
            "select_options": [
                {
                    "value": 'opt1',
...
class Settings(PluginSettings):
    settings = {
        "NVENC Encoder Quality Preset": "p4",
    }
    form_settings = {
...
![Unmanic Plugins - Settings Advanced Browse Directory](/img/unmanic-plugin-settings-advaced-browse-directory.png "unmanic-plugin-settings-advaced-browse-directory")
