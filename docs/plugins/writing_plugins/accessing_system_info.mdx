...
on what a plugin may carryout when it's [**runner**](/docs/plugins/writing_plugins/introduction#runners)
processes are called.


To aid a Plugin in carrying out system specific tasks, a **System** class has been provided 
to feed data to the [**Plugin module**](/docs/plugins/writing_plugins/introduction#plugin-module) at the 
