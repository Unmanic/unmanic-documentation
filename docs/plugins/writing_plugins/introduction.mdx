...
| Runner Type                    | Ducumentation                                                  |
|--------------------------------|----------------------------------------------------------------|
| on_worker_process              | [LINK](/docs/plugins/writing_plugins/runner_on_worker_process) |
| on_postprocessor_file_movement | [LINK](/plugins/writing_plugins/runner_on_worker_process)      |
| on_postprocessor_task_results  | [LINK](/plugins/writing_plugins/runner_on_worker_process)      |
