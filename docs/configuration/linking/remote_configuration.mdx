...
<img className={"screenshot"} src={require('/img/unmanic-link-configure.png').default} />
...
<img className={"screenshot"} src={require('/img/unmanic-link-configure-send-disabled.png').default} />
:::
...
<img className={"screenshot"} src={require('/img/unmanic-link-configure-send-with-preload.png').default} />
...
<img className={"screenshot"} src={require('/img/unmanic-link-configure-distributed-worker-count.png').default} />
