...
<img
  ...
  style={{ width: "400px" }}
  src={require("/img/unmanic-settings-library-scanning.png").default}
/>

### Options

The options for the library scanner are configured under the _Library_ section in Unmanic's settings.
