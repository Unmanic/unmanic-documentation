...
Follow the [Windows 10/11 (WSL + Docker) installation guide](/docs/installation/windows_wsl) if you wish to
...
* [NVIDIA Hardware Acceleration](/docs/advanced/docker_hardware_accelerated_encoding_nvidia)
* [VAAPI Hardware Acceleration](/docs/advanced/docker_hardware_accelerated_encoding_vaapi)
