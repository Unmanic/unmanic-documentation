---
title: Docker
description: Unmanic Installation - Docker
id: docker
---
...
:::info
ARM builds have been removed until further notice. If you wish to run Unmanic on ARM architectures, 
it would be my suggestion to run it natively.
:::
