...
You will see more details regarding your Pending Tasks list if you expand the card by clicking the <img className={"inline-text-screenshot"} src={require('/img/unmanic-dashboard-show-more-button.png').default} title={"Show more"} /> button in the top-right corner.
