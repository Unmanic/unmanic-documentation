...
To view all Pending tasks, click the *Show more* icon in the top-right corner.


## Managing Pending Tasks

You will see more details regarding your Pending Tasks queue if you expand the card by clicking the <img className={"inline-text-screenshot"} src={require('/img/unmanic-dashboard-show-more-button.png').default} title={"Show more"} /> button in the top-right corner.
