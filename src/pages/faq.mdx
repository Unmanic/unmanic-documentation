...
1. Visit `https://api.unmanic.app/support-auth-api/link` and log in (log out first if you were already logged in).
...
Current policy is that if you are a current supporter (or have been active at some point in the previous 12 months) and your total sponsorship in that 12-month window reached at least $36 USD, lifetime unlock is applied automatically.
